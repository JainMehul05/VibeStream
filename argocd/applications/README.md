...
```
applications/
└── vibestream-backend.yaml    VibeStream Django backend (Helm chart in ../../helm/vibestream-backend)
```
...
kind: Application
metadata:
  name: VibeStream-root
  namespace: argocd
spec:
  project: default
  source:
    repoURL: https://github.com/YOUR_GITHUB_USERNAME/VibeStream.git
