...
Plus the per-VibeStream customisations:
...
│   ├── VibeStream-overview.json
│   ├── VibeStream-inference.json
│   ├── VibeStream-postgres.json
│   └── README.md
└── values/
...
into Grafana picks it up under the **VibeStream** folder.
