...
resource "aws_kms_key" "redis" {
  description             = "KMS key for VibeStream Redis encryption"
...
resource "aws_security_group" "this" {
  name        = local.name
  description = "VibeStream Redis access"
  vpc_id      = var.vpc_id
  tags        = local.tags
}
...
resource "aws_elasticache_parameter_group" "this" {
  ...
  description = "VibeStream Redis tuning"
  tags        = local.tags
...
resource "aws_elasticache_replication_group" "this" {
  ...
  description                   = "VibeStream Redis (${var.environment})"
