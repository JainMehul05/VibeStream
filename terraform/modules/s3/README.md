...
module "buckets" {
  ...
  bucket_names = [
    "vibestream-prod-uploads",
    "vibestream-prod-backups",
    "vibestream-prod-static",
  ]
  kms_key_arn          = aws_kms_key.app.arn
  intelligent_tiering  = true
  access_log_target_bucket = "vibestream-prod-access-logs"
}
...
data "aws_iam_policy_document" "app_reads_uploads" {
  statement {
    ...
    resources = ["${module.buckets.bucket_arns["vibestream-prod-uploads"]}/*"]
  }
}
```
