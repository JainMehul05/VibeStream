# VibeStream Deployment Architecture

Comprehensive visual documentation of the VibeStream deployment architecture using Mermaid diagrams.
...
graph TB
    subgraph Cluster["Kubernetes Cluster"]
        subgraph Namespaces["Namespaces"]
            NS_PROD[vibestream-production]
            NS_STAGE[vibestream-staging]
            NS_MON[monitoring]
        end
        ...
        subgraph NS_PROD_Resources["Production Resources"]
            ...
            subgraph Config["Configuration"]
                CM[ConfigMap:<br/>VibeStream-config]
                SECRET[Secret:<br/>vibestream-secrets]
            end
        ...
        subgraph Istio_Resources["Istio (Optional)"]
            ...
            GW[Gateway:<br/>VibeStream-gateway]
        end
    end
...
This document provides comprehensive visual documentation of the VibeStream deployment architecture using Mermaid diagrams. All diagrams are rendered automatically in Markdown-compatible viewers.
