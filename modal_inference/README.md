# VibeStream ML Inference Service
...
<p align="center">
  Standalone serverless ML inference service for VibeStream, deployed on
...
flowchart LR
    ...
    subgraph Modal["Modal serverless"]
        ...
        Secret[("Modal Secret<br/>vibestream-secrets")]
    end
...
All values come from a single Modal Secret named `vibestream-secrets`,
...
modal secret create vibestream-secrets \
