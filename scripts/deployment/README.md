...
| `REGISTRY`              | `ghcr.io/JainMehul05` | Container registry                         |
...
./blue-green-deploy.sh \
  --image ghcr.io/JainMehul05/vibestream-backend:abc123 \
...
* [`../../helm/vibestream-backend/`](../../helm/vibestream-backend/) — Helm chart
