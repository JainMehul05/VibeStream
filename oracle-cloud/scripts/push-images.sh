#!/usr/bin/env bash
# =============================================================================
# Build + push VibeStream images to OCIR
# =============================================================================
# Usage:
...
FRONTEND_IMAGE="${REGISTRY}/vibestream-frontend:${IMAGE_TAG}"
BACKEND_IMAGE="${REGISTRY}/vibestream-backend:${IMAGE_TAG}"
AI_ML_IMAGE="${REGISTRY}/vibestream-ai-ml:${IMAGE_TAG}"
NGINX_IMAGE="${REGISTRY}/vibestream-nginx:${IMAGE_TAG}"
...
To roll out:
  kubectl set image deploy/vibestream-backend backend=${BACKEND_IMAGE} -n vibestream-production
EOF
