...
<p align="center">
  <img src="../images/vibestream-logo.png" alt="Moodify" width="160" />
</p>
...
```bash
# mobile/.env
EXPO_PUBLIC_API_URL=https://api.vibestream.example.com
EXPO_PUBLIC_MODAL_API_URL=https://YOUR-MODAL-INFERENCE-URL
```
...
```bash
npx eas-cli login
npx eas-cli env:create EXPO_PUBLIC_API_URL --value https://api.vibestream.example.com
