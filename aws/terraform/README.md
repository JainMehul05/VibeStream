...
Self-contained Terraform root for the AWS deployment of VibeStream. Stands
...
aws s3api create-bucket --bucket VibeStream-terraform-state --region us-east-1
aws s3api put-bucket-versioning --bucket VibeStream-terraform-state \
  --versioning-configuration Status=Enabled
aws dynamodb create-table \
  --table-name VibeStream-terraform-locks \
