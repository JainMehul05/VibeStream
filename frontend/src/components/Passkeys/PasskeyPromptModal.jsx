...
// the VibeStream look. Runs the WebAuthn enrollment ceremony inline using the
...
const PERKS = [
  ...
  },
  {
    ...
    body: "Your passkey only works on VibeStream and never leaves your device.",
  },
  {
    icon: <PhonelinkLock />,
    ...
    >
      ...
      <Box sx={styles.hero}>
        ...
        <Typography sx={styles.heroSub}>
          A safer, faster way to sign in to VibeStream.
        </Typography>
      </Box>
