          ...
          <Grid container spacing={{ xs: 4, md: 8 }} alignItems="center">
            <Grid item xs={12} md={6}>
              ...
              <Typography
                ...
                {...getRevealProps(2)}
              >
                From calm mornings to high-energy workouts, VibeStream interprets
          ...
          <Grid container spacing={4} alignItems="center">
            <Grid item xs={12} md={4} {...getRevealProps(1)}>
              ...
              <Typography variant="body1" sx={styles.sectionSubtitleLeft}>
                VibeStream is a universal design-first music companion. Every
        ...
        <Container maxWidth="lg">
          <Grid container spacing={5} alignItems="center">
            <Grid item xs={12} md={6} {...getRevealProps(1)}>
              ...
              <Typography variant="body1" sx={styles.sectionSubtitleLeft}>
                VibeStream blends contextual signals, mood check-ins, and listening
            ...
            <Grid item xs={12} md={6} {...getRevealProps(2)}>
              <Card sx={styles.moodCard}>
                <CardContent>
                  ...
                  <Typography variant="body2" sx={styles.statCaption}>
                    See how VibeStream interprets your emotional blend in real
                    time.
                  </Typography>
        ...
        <Container maxWidth="lg">
          <Grid container spacing={4} alignItems="center">
            <Grid item xs={12} md={5} {...getRevealProps(1)}>
              ...
              <Typography variant="body1" sx={styles.sectionSubtitleLeft}>
                Every VibeStream moment is tuned for responsiveness and clarity.
            ...
            <Grid item xs={12} md={7} {...getRevealProps(2)}>
              <Card sx={styles.signalCard}>
                <CardContent>
                  ...
                  <Typography variant="body2" sx={styles.statCaption}>
                    Real-time health metrics across the VibeStream pipeline.
                  </Typography>
      ...
      <Box sx={styles.sectionAlt}>
        <Container maxWidth="lg">
          ...
          <Typography
            ...
            {...getRevealProps(2)}
          >
            VibeStream adapts to the settings you care about most, from work and
        ...
        <Container maxWidth="lg">
          <Grid container spacing={4} alignItems="center">
            <Grid item xs={12} md={5} {...getRevealProps(1)}>
              ...
              <Typography variant="body1" sx={styles.sectionSubtitleLeft}>
                VibeStream connects with the tools you already use so your
        ...
        <Container maxWidth="lg">
          <Grid container spacing={4} alignItems="center">
            <Grid item xs={12} md={6} {...getRevealProps(1)}>
              ...
              <Typography variant="body1" sx={styles.sectionSubtitleLeft}>
                We designed VibeStream to be welcoming for every listener with
            ...
            <Grid item xs={12} md={6} {...getRevealProps(2)}>
              <Card sx={styles.trustCard}>
                <CardContent>
                  ...
                  <Typography variant="body2" sx={styles.statCaption}>
                    Your emotions stay yours. VibeStream uses privacy-first design
      ...
      <Box sx={styles.sectionAlt}>
        <Container maxWidth="lg">
          ...
          <Typography
            ...
            {...getRevealProps(2)}
          >
            From creators to wellness teams, VibeStream brings emotional clarity to
            every playlist.
          </Typography>
          <Grid container spacing={3}>
      ...
      <Box sx={styles.section}>
        <Container maxWidth="lg">
          ...
          <Typography
            ...
            {...getRevealProps(1)}
          >
            Emotions VibeStream understands
          </Typography>
          <Typography
            variant="body1"
            sx={styles.sectionSubtitle}
            {...getRevealProps(2)}
          >
            However you feel, there is a soundtrack for it. Here is how VibeStream
      ...
      <Box sx={styles.sectionAlt}>
        <Container maxWidth="lg">
          ...
          <Typography
            ...
            {...getRevealProps(2)}
          >
            Everything you need to know about getting started with VibeStream.
          </Typography>
          <Stack spacing={2}>
            {faqs.map((faq, index) => (
      ...
      <Box sx={styles.ctaSection}>
        <Container maxWidth="md" sx={{ position: "relative", zIndex: 1 }}>
          ...
          <Typography
            ...
            {...getRevealProps(2)}
          >
            Join VibeStream and create playlists that evolve with every feeling.
...
const features = [
  ...
  },
  {
    ...
    description: "VibeStream adjusts your soundtrack as your energy shifts.",
    icon: Tune,
  },
  {
...
const steps = [
  {
    title: "Check in",
    description: "Tell VibeStream how you feel using any input method.",
    icon: CameraAlt,
  },
  {
    title: "Analyze",
...
const integrations = [
  ...
  {
    title: "Focus Tools",
    description: "Pair VibeStream with timers and productivity stacks.",
  },
  {
...
const testimonials = [
  {
    ...
    initials: "RN",
    role: "Creator",
    text: "VibeStream helps me dial in the exact vibe I need before recording.",
  },
  {
  ...
  },
  {
    ...
    initials: "RL",
    role: "Student",
    text: "VibeStream makes studying feel effortless and focused.",
  },
  {
    author: "Amina Noor",
    initials: "AN",
    role: "Team Lead",
    text: "We use VibeStream during team focus blocks and it just works.",
  },
  {
    author: "Luis Ortega",
    initials: "LO",
...
const faqs = [
  {
    question: "How does VibeStream understand my mood?",
    answer:
      "VibeStream blends your input with contextual signals to interpret your current emotional state and recommend playlists that match your intent.",
  },
  {
    question: "Can I use VibeStream without camera or voice input?",
    answer:
      "Yes. Text-based mood check-ins are always available and work seamlessly with the recommendation engine.",
  },
  {
    question: "Is VibeStream available on mobile and desktop?",
    answer:
      "VibeStream syncs across devices, so you can start a session on web and continue on mobile or desktop without losing context.",
  },
  {
  ...
  {
    question: "Can teams use VibeStream together?",
    answer:
      "Teams can share focus sessions, mood journeys, and curated playlists while keeping individual preferences private.",
  },
  {
    question: "What makes VibeStream different?",
    answer:
      "VibeStream is built for emotional clarity with universal design principles, making it easy, inclusive, and personalized for every listener.",
  },
];
...
const getStyles = (isDarkMode) => {
  ...
  return {
    ...
    marqueeTrack: {
      ...
      width: "max-content",
      gap: "16px",
      animation: "VibeStreamMarquee 32s linear infinite",
