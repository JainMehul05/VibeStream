...
const TermsOfServicePage = () => (
  <LegalLayout
    ...
    intro={
      "Welcome to VibeStream. By using our application you agree to these Terms of Service. Please read them carefully - they set out what you can expect from us and what we ask of you."
    }
    sections={[
      {
        ...
        body: (
          <p>
            By creating an account or otherwise using VibeStream, you agree to be
        ...
        body: (
          <>
            <p>
              ...
              web player. Deezer's own terms apply to playback; VibeStream is not
      ...
      },
      {
        ...
        body: (
          <p>
            VibeStream is provided "as is" without warranties of any kind. We make
      ...
      },
      {
        ...
        body: (
          <p>
            To the maximum extent permitted by law, VibeStream and its maintainer
