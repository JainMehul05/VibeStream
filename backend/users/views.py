...
_REGISTER_BODY = _obj(
    properties={
        "username": openapi.Schema(type=openapi.TYPE_STRING, example="vibestream_user"),
    ...
    example={"username": "vibestream_user", "email": "user@example.com",
...
_LOGIN_BODY = _obj(
    ...
    example={"username": "vibestream_user", "password": "hunter2-correct-horse"},
)
...
@swagger_auto_schema(
    ...
    responses={
        200: openapi.Response(
            ...
            examples={"application/json": {"message": "Token is valid.", "username": "vibestream_user"}},
        ),
        401: RESP_401,
    },
)
