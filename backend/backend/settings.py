"""Django settings for the VibeStream API.
...
# Sentry (project: unc-a4/vibestream-app). Entirely opt-in: with no SENTRY_DSN
...
#
#   WEBAUTHN_RP_ID          bare domain, no scheme/port  (e.g. vibestream-app.vercel.app)
...
WEBAUTHN_RP_NAME = config("WEBAUTHN_RP_NAME", default="VibeStream")
