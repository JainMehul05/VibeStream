...
class TestRegisterBegin:
    def test_requires_auth(self, api_client):
        resp = api_client.post("/api/v1/users/passkeys/register/begin/", {}, format="json")
        assert resp.status_code in (401, 403)

    def test_returns_options_and_stores_challenge(self, auth_client):
        resp = auth_client.post("/api/v1/users/passkeys/register/begin/", {}, format="json")
...
class TestRegisterComplete:
    def _begin(self, auth_client):
        return auth_client.post("/api/v1/users/passkeys/register/begin/", {}, format="json").data["flowId"]
    ...
    def test_happy_path_creates_credential(self, auth_client, monkeypatch):
        ...
        resp = auth_client.post(
            "/api/v1/users/passkeys/register/complete/",
...
class TestLoginBegin:
    def test_usernameless_returns_options(self, api_client):
        resp = api_client.post("/api/v1/users/passkeys/login/begin/", {}, format="json")
        assert resp.status_code == 200
    ...
    def test_username_scopes_allow_credentials(self, api_client, make_user):
        ...
        resp = api_client.post("/api/v1/users/passkeys/login/begin/", {"username": "scoped"}, format="json")
    ...
    def test_unknown_username_does_not_disclose(self, api_client):
        ...
        resp = api_client.post("/api/v1/users/passkeys/login/begin/", {"username": "ghost"}, format="json")
        assert resp.status_code == 200
...
class TestLoginComplete:
    def _begin(self, api_client, username=None):
        ...
        return api_client.post("/api/v1/users/passkeys/login/begin/", body, format="json").data["flowId"]
    ...
    def test_happy_path_issues_tokens(self, api_client, make_user, monkeypatch):
        ...
        resp = api_client.post(
            "/api/v1/users/passkeys/login/complete/",
    ...
    def test_issued_token_authenticates(self, api_client, make_user, monkeypatch):
        ...
        me = api_client.get("/api/v1/users/validate_token/")
...
class TestManage:
    def test_list_requires_auth(self, api_client):
        resp = api_client.get("/api/v1/users/passkeys/")
        assert resp.status_code in (401, 403)
    ...
    def test_list_only_returns_own(self, auth_client, make_user):
        ...
        resp = auth_client.get("/api/v1/users/passkeys/")
        assert resp.status_code == 200
    ...
    def test_rename(self, auth_client):
        ...
        resp = auth_client.patch(f"/api/v1/users/passkeys/{cred.id}/", {"name": "New name"}, format="json")
        assert resp.status_code == 200
        cred.reload()
    ...
    def test_rename_empty_rejected(self, auth_client):
        ...
        resp = auth_client.patch(f"/api/v1/users/passkeys/{cred.id}/", {"name": "   "}, format="json")
        assert resp.status_code == 400

    def test_rename_truncated_to_max_length(self, auth_client):
        cred = _make_credential(auth_client.user, credential_id="rn-3")
        resp = auth_client.patch(f"/api/v1/users/passkeys/{cred.id}/", {"name": "z" * 200}, format="json")
        assert resp.status_code == 200
        cred.reload()
    ...
    def test_cannot_rename_others(self, auth_client, make_user):
        ...
        resp = auth_client.patch(f"/api/v1/users/passkeys/{cred.id}/", {"name": "hacked"}, format="json")
    ...
    def test_delete(self, auth_client):
        ...
        resp = auth_client.delete(f"/api/v1/users/passkeys/{cred.id}/")
        assert resp.status_code == 200
    ...
    def test_bad_id_is_404(self, auth_client):
        resp = auth_client.delete("/api/v1/users/passkeys/not-an-objectid/")
        assert resp.status_code == 404
